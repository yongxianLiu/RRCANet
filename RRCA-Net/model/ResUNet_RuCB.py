...
class ResUNet_RuCB(nn.Module):
    def __init__(self, num_classes, input_channels, block, num_blocks, iterations=2, multiplier=1.0, num_layers=5, integrate=True, deep_supervision=False):
