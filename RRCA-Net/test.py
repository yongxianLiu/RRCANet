...
class Trainer(object):
    def __init__(self, args):
        ...
        if args.model   == 'DNANet':
            ...
            model       = RRCANet(num_classes=1, input_channels=args.in_channels, block=Res_block, num_blocks=num_blocks, iterations=args.iter, num_layers=args.num_layers, multiplier=args.multiplier, integrate=args.integrate, deep_supervision=args.deep_supervision)
        elif args.model == 'AMFU':
            model       = AMFU()
        # elif args.model == 'AMFU_RuCB':
            # model       = AMFU_RuCB(n_classes=1, in_channels=args.in_channels,iterations=args.iter, num_layers=args.num_layers, multiplier=args.multiplier, integrate=args.integrate, deep_supervision=args.deep_supervision)
        ...
        with torch.no_grad():
            ...
            scio.savemat(dataset_dir + '/' +  'value_result'+ '/' +args.st_model  + '_PD_FA_' + '.mat',
