...
class LW_IRST_ablation(nn.Module):
    def __init__(self, n_classes=1, in_channels=1, encoder_relu=False, decoder_relu=True, channel=(8, 32, 64), dilations=(2,4,8,16), kernel_size=(3,5,7,9), padding=(1,2,3,4)):
        super().__init__()

        # Stage 1 - Encoder
        self.initial_block = InitialBlock(in_channels=in_channels, out_channels=channel[0], relu=encoder_relu)
