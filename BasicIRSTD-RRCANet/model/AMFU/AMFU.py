...
class AMFU(nn.Module):
    def __init__(self, in_channels=1, n_classes=1, is_deconv=True, is_batchnorm=True,mode='test'):
    ...
    def forward(self, inputs):
        ...
        if self.mode == 'train':
            return [d5.sigmoid(), d4.sigmoid(), d3.sigmoid(), d2.sigmoid(), d1.sigmoid(), fused_feature.sigmoid()]
        else:
            return fused_feature.sigmoid()